...
```
http://localhost:5173/asset-pipeline.html?themeId=<theme_id>
```

说明：`asset-pipeline.html` 是开发/演示用页面，用来查看 ThemeAssetPackage 的资产缩略图和结构化 JSON，不从玩家主菜单暴露。
...
- 视频管线导入的主题会同时写入对应视频文件和主题资产包：
  - `client/public/videos/<theme_id>.mp4`
